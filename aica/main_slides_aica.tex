...
invisibile che generano più di un token.
  ...
  \frame{
   ...
   \begin{center}
      \includegraphics[scale=0.5]{./fig/LogConformance}
    \end{center}
    
       \begin{center}
      \includegraphics[scale=0.4]{./fig/residencyPNConformance}
    \end{center}
...
un altro place.
  ...
  \frame{
   ...
   \begin{center}
      \includegraphics[scale=0.5]{./fig/Log}
    \end{center}
    
       \begin{center}
      \includegraphics[scale=0.4]{./fig/PerformanceProM6PatchConAnnotazioni}
    \end{center}
    
    
    \begin{center}
      \includegraphics[scale=0.3]{./fig/residencyHiLevel}
    \end{center}

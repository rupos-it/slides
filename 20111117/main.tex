...
\frame{
  Example of BPMN Rupos process
  
  \begin{center}
    \includegraphics[scale=0.15]{./fig/BPMN}
  \end{center}
...
\frame{
  ...
  \begin{center}
    \includegraphics[scale=0.15]{./fig/exampleBPMNtoPn}
  \end{center}
...
\frame{
  Example of conformance and performance analyses
  \begin{center}
    \includegraphics[scale=0.15]{./fig/examplePnconformance}\\
    \includegraphics[scale=0.15]{./fig/examplePnPerformance}
  \end{center}
...
\frame{
  ...
  BPMN process
  \begin{center}
    \includegraphics[scale=0.15]{./fig/exampleBPMNConformance}\\
    \includegraphics[scale=0.15]{./fig/exampleBPMNPerformance}
  \end{center}
